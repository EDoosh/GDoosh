...
commentHistory('viprin', 'recent', 0, 1024);
...
async function commentHistory(un, m = 'liked', pg = 0, cnt = 5) {
	...
	if (!resp || resp == '-1') return console.log(resp); // If resp is undefined or servers returned nothing (-1 in robtop speak), return error
