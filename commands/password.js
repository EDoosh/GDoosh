...
module.exports.run = async (bot, message, args) => {
	...
	if (args[1] === 'u') {
		if (!passwords.has(message.author.id)) return message.channel.send(`You do not have a password associated with this account yet!`);
		...
		message.channel.send(`Successfully deleted your password from the bot's database!`);
	} else {
